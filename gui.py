...
frame = Frame(root, bg='#ccc6ff', bd=5)
frame.place(relx=0.5, rely=0.1, relwidth=.75, relheight=.1, anchor='n')

button = Button(frame, text="Show stonks", fg = 'red', command = lambda: testing(entry.get()))
...
label = Label(root, text="Enter Stock Label Below")
